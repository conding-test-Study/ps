# DFS를 실행하려고 했으나, '3번 노드에 4번 노드가 연결'을 graph[3] = 4 식으로 표현하기는 어려웠음
# 해당 문제를 해결하기 위해 아이디어 참고 (출처: https://velog.io/@ledcost/프로그래머스-43164-파이썬-여행경로-level-3-BFSDFS)
...
def solution(tickets):
    ...
    def getPath(t, path):
        ...
        while t[valid_idx][0] == now:
            nxt_path = getPath(
                t[:valid_idx] + t[valid_idx + 1:], path + [t[valid_idx][1]])
