...
# 80 10 20 30   100
# 80 10 이렇게 선택해버리면 20이 나왔을 떄 10을 뺴버리고 20을 넣는데 어떻게 해 ? 
100을 꽉채워야 다음에 90이 나올때 10 90 해서 생각했는데 생각해보니
#나는 정렬도 생각못하고 ,       정렬하고나서 큰거하나 작은거 하나 뽑을 생각을 못했던것같다
#아니면 그냥 스쳐지나 생각만하고 그냥 넘어가고 다른거 보고있었음 기록했다가 방법 하나씩 직접 해봤어야..
#근데 이정도면 몇번풀면 풀이가 생각날것같은데 


# 10 10 20 30 40 50 
# 10 10 20 30  ->   10 40 20 30 
#정렬하고 이렇게있을떄 어떻게 바꾸냐 생각했던것 같은데 생각해보니 2개 가지고 만드는거였음ㅋㅋ.. 그냥 문제 이해를 잘 못하는데 하나씩 문제있는 단어를 다 고려해야하는데
